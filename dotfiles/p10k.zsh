# Generated by Powerlevel10k configuration wizard on 2020-07-15 at 20:05 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    php_version           # php version (https://www.php.net/) JS
    ...
    newline
		sshlvls									# SSH Levels
		shlvl										# Show Shell Level
		shver										# UserFiles.tgz version
		date
    # =========================[ Line #3 ]=========================
    newline
    # ip                    # ip address and bandwidth usage for a specified network interface
    #context                 # user@hostname #JS
    public_ip             # public IP address #JS
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='⭐'
     typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_BACKGROUND=160
  ...
  # Colors for different levels of disk usage.
   ...
   typeset -g POWERLEVEL9K_DISK_USAGE_NORMAL_BACKGROUND=239
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
   typeset -g POWERLEVEL9K_RAM_FOREGROUND=0 #JS
   typeset -g POWERLEVEL9K_RAM_BACKGROUND=3 #JS
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_PHPENV_PROMPT_ALWAYS_SHOW=true #JS
  ...
  # Public IP color.
   typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=7 #JS
   typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND=239 #JS
  # Custom icon.
  ...
  #####################################[ wifi: wifi speed ]#####################################
  # WiFi color.
   typeset -g POWERLEVEL9K_WIFI_FOREGROUND=0 #JS
   typeset -g POWERLEVEL9K_WIFI_BACKGROUND=4 #JS
  # Custom icon.
  ...
  function prompt_example() {
	...
	function prompt_shlvl() {
		p10k segment -b 2 -f 0 -t "sh:${SHLVL}"
	}

	# zsh UserFiles.tgz version
	function prompt_shver() {
		p10k segment -b 91 -f 0 -t "sv:$(cat ~/.zsh_shver)" 
	}

	# How many SSH connections
	function prompt_sshlvls() {
		p10k segment -b 3 -f 0 -t "ssh:${LC_SSHLVLS}" 
	}

	# Show Username
	function prompt_user() {
		if [ $UID -eq 0 ]; then
			p10k segment -b 88 -f 255 -t "$(echo -e ${USER})" 
		else
			p10k segment -b 22 -f 255 -t "$(echo -e ${USER})" 
		fi
	}
	...
	function prompt_host() {
		if [ $UID -eq 0 ]; then
			p10k segment -b 88 -f 255 -t "$(/bin/hostname -s)" 
		else
			p10k segment -b 22 -f 255 -t "$(/bin/hostname -s)" 
		fi
	}

	# Whether VPN is connected or not
	function prompt_vpn() {
		if [ "$(uname)" = "Darwin" ]; then
			local vpnislive=$(ifconfig | egrep 'ipsec0:')
			if [ -z ${vpnislive} ]; then
				p10k segment -b 237 -f 196 -t 'X'
			else
				p10k segment -b 237 -f 2 -t 'V'
			fi
		else
